...
changeCourse(newCourseName){
    ...
    if(this.#isCourseNameValid(newCourseName) && this.#student.sId !== 0){ // how to do != old course
        this.#student.sCourseDetails.courseName = courseData.courseName;
        this.#student.sCourseDetails.courseLength = courseData.length;
        this.#student.sCourseDetails.coursePrice = courseData.price;
        this.#student.sBalance = courseData.price;
        console.log(`\nCourse has been successfully changed to ${courseData.courseName}\n\nNew course details:`);
    }
...
makePayment(amount);{
    if(amount > 0 && amount <= this.#student.sBalance){
        this.#student.sBalance = this.#student.sCourseDetails.coursePrice - amount;
        console.log(`Thank you for making payment of $${amount}\nYour new balance is -> $${this.#student.sBalance}`);
    }
}
studentGrade();{
    this.#student.sGrade
